...
import permissionRouteConfig from './routes/permission.js';
import rolepermissionRouteConfig from './routes/rolepermission.js';
...
export default class AsExpress {
  ...
  async #setAdminRolePermissions() {
    ...
    await this.#database.setPermissionProfileAssignmentsForRole('admin', permissionProfileKeys);
  }
  ...
  #initApiRouter() {
    ...
    this.addRouter('/api/role', rolepermissionRouteConfig);
    this.addRouter('/api/permission', permissionRouteConfig);
