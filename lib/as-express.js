...
export default class AsExpress {
  ...
  addRouter(urlPath, routeConfig) {
    ...
    if (routeConfig && routeConfig.routes) {
      this.#addCorsHandlerToRouter(router, routeConfig.path, urlPath, corsOptions);
  ...
  #addCorsHandlerToRouter(router, routerPath, urlPath, corsOptions) {
    console.log(`adding express router for options ${urlPath} ${routerPath}`);
    corsOptions.credentials = true;
    router.options(routerPath, (req, res, next) => {
      console.log('doCORS');
